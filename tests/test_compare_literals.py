...
class LiteralConstraintTests(unittest.TestCase):
    def test_root_enum_narrowing_is_breaking(self) -> None:
    ...
    def test_root_enum_expansion_is_compatible(self) -> None:
    ...
    def test_gaining_root_enum_constraint_is_breaking(self) -> None:
    ...
    def test_boolean_and_number_enum_values_are_not_aliased(self) -> None:
    ...
    def test_numerically_equal_json_numbers_remain_compatible(self) -> None:
    ...
    def test_object_enum_identity_ignores_key_order(self) -> None:
        result = _compare(
    ...
    def test_const_boolean_to_number_is_breaking(self) -> None:
    ...
    def test_nested_property_enum_is_checked_once(self) -> None:
        result = _compare(
    ...
    def test_local_defs_literal_constraint_is_checked(self) -> None:
        result = _compare(
            {
                "type": "object",
    ...
    def test_malformed_enum_change_fails_closed(self) -> None:
