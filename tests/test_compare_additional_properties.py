...
class AdditionalPropertiesTests(unittest.TestCase):
    def test_closing_root_object_is_breaking(self) -> None:
        result = _compare(
    ...
    def test_explicit_true_to_false_is_breaking(self) -> None:
        result = _compare(
    ...
    def test_opening_closed_object_is_compatible(self) -> None:
        result = _compare(
            {"type": "object", "additionalProperties": False},
            {"type": "object"},
        )
    ...
    def test_empty_schema_is_equivalent_to_default_open(self) -> None:
        result = _compare(
            {"type": "object"},
    ...
    def test_new_schema_for_extra_values_is_breaking(self) -> None:
        result = _compare(
            {"type": "object"},
    ...
    def test_schema_to_false_is_breaking(self) -> None:
        result = _compare(
            {"type": "object", "additionalProperties": {"type": "string"}},
            {"type": "object", "additionalProperties": False},
        )
    ...
    def test_changed_extra_value_schema_fails_closed(self) -> None:
        result = _compare(
            {"type": "object", "additionalProperties": {"type": "string"}},
    ...
    def test_nested_object_closure_is_detected(self) -> None:
        result = _compare(
            {
                "type": "object",
                "properties": {
    ...
    def test_local_defs_object_closure_is_detected(self) -> None:
        result = _compare(
            {
                "type": "object",
    ...
    def test_malformed_candidate_additional_properties_fails_closed(self) -> None:
        result = _compare(
            {"type": "object", "additionalProperties": True},
